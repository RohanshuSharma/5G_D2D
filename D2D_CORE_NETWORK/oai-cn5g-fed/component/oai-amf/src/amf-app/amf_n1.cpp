...
nc->end =clock();
double elapsed_time = static_cast<double>(nc->end - nc->start) / (CLOCKS_PER_SEC / 1000.0);
Logger::amf_n1().info("Time taken by CORE NETWORK: %.2f milliseconds", elapsed_time);
